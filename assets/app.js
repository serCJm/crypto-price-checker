      ...
      makeRequest(
        ...
        function(data) {
          ...
          Object.keys(coins).forEach(function(key) {
            ...
            if (
              match.test(coins[key].CoinName) === true ||
              match.test(coins[key].Symbol)
            ) {
              // filter out small coins
              if (
                coins[key].IsTrading === true &&
                coins[key].SortOrder <= 100
              ) {
      ...
      makeRequest(
        ...
        function(data) {
          ...
          Object.keys(coins).forEach(function(key) {
            ...
            if (
              inputVal.value.toUpperCase() === coins[key].CoinName.toUpperCase()
            ) {
          ...
          if (!symbol) {
            Object.keys(coins).forEach(function(key) {
              ...
              if (
                inputVal.value.toUpperCase() === coins[key].Symbol.toUpperCase()
              ) {
                symbol = coins[key].Symbol;
                lookupPrice.call(symbol);
              }
            ...
            if (!symbol) {
              priceNotFound.call(
                "There is no data for the " + inputVal.value.toUpperCase()
              );
            }
          }
        }
